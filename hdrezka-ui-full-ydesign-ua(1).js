 ...
 * Акценти жовто-блакитні; обводка — лише на картках і бейджах.
 */
(function () {
    'use strict';
    ...
    function inject() {
        ...
        var css = `
/* =====================================================
   HDRezka Style ${VERSION} — UA accents, outline only cards + badges
   ===================================================== */
...
.card {
    ...
    box-shadow: 0 0 0 1px rgba(0, 87, 184, 0.45) !important;
}
...
`;
    ...
    function start() {
        inject();
        console.log('[HDRezka Style UA] v' + VERSION + ' loaded (outline: cards + badges only)');
    }
